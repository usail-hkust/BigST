...
class DataLoader(object):
    def __init__(self, data, batch_size, pad_with_last_sample=True):
        """
        :param xs:
        :param ys:
        :param batch_size:
        ...
        """
        self.seq_length_x = 12
        self.seq_length_y = 12
        self.y_start = 1
        ...
        self.min_t = abs(min(self.x_offsets))+2016
...
def load_dataset(dataset_dir, batch_size, valid_batch_size= None, test_batch_size=None):
    ...
    data['train_loader'] = DataLoader(data['train'], batch_size)
    data['val_loader'] = DataLoader(data['val'], valid_batch_size)
    data['test_loader'] = DataLoader(data['test'], test_batch_size)
    data['scaler'] = scaler
    return data
