...
class DataLoader(object):
    def __init__(self, data, batch_size, seq_num):
        self.seq_length_x = seq_num
        self.seq_length_y = seq_num
        self.y_start = 1
...
def load_dataset(dataset_dir, batch_size, valid_batch_size, test_batch_size, seq_num):
    data = {}
    ...
    data['train_loader'] = DataLoader(data['train'], batch_size, seq_num)
    data['val_loader'] = DataLoader(data['val'], valid_batch_size, seq_num)
    data['test_loader'] = DataLoader(data['test'], test_batch_size, seq_num)
    data['scaler'] = scaler
    return data
