...
parser.add_argument('--data_path',type=str,default='/data/pems_data/pems_vldb/short_term',help='data path')
parser.add_argument('--adjdata',type=str,default='/data/pems_data/pems_vldb/adj_pems.npy',help='adj data path')
