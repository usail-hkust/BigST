...
import time
import util
from pipline import train_pipline

parser = argparse.ArgumentParser()
parser.add_argument('--device',type=str,default='cuda:1',help='')
parser.add_argument('--data',type=str,default='../../data/pems_new',help='data path')
parser.add_argument('--adjdata',type=str,default='../../data/pems_new/adj_speed.npy',help='adj data path')
...
def main():
    ...
    trainer = train_pipline(scaler, args.seq_num, args.in_dim, args.hid_dim, args.num_nodes, args.tau, \
