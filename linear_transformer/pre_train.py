...
parser.add_argument('--data',type=str,default='../../../data/pems_vldb/long_term',help='data path')
parser.add_argument('--adjdata',type=str,default='../../../data/pems_small/adj_speed.npy',help='adj data path')
...
def main():
    ...
    trainer = train_pipeline(scaler, args.in_dim, args.seq_length, args.num_nodes, args.nhid, args.dropout,
    ...
    for i in range(1, args.epochs+1):
        ...
        for iter, (x, y) in enumerate(dataloader['train_loader'].get_iterator()):
            ...
            if iter % args.print_every == 0:
                ...
                torch.save(trainer.model.state_dict(), args.save+"kernel_transformer.pth")
